...
This Code of Conduct applies within all community spaces for CAPS, and also applies when an individual is officially representing the community in public spaces (for example using an official email address, posting via an official social account, or acting as an appointed representative at an online or offline event).
